...
// Utility type for requiring certain properties
...
export const Logger = new (class Logger {
	...
	configure(provider: LogChannelProvider, logLevel: LogLevel, debugging: boolean = false) {
		...
		// Reset the output channel so it gets recreated with the new provider
...
export class BufferedLogChannel implements LogChannel {
	...
	constructor(
		...
		private readonly maxBufferSize: number = maxBufferedLines,
	) {}
